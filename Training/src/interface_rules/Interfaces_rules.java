...
interface Interfaces_rules {  
	 ...
	 *  Interface was created after the abstract class (Java 8) and it has similar functions to abstract class (only different variables, Interface has only unchangable variables);
	 ...
	 *   It is the main difference between extends and implements. Note that extends and implements are reserved keywords in Java and cannot be used as identifiers.
	 *   
