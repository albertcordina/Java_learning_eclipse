package thread;
//   https://github.com/java-23-e01/exercise-ticket-booking-system-albertcordina
public class TicketBookingExercise {
	
	public static void main(String[] args) {
		
	 TicketBookingSystem ticketBookingSystem = new TicketBookingSystem(10); // Initialize with 10 tickets;
